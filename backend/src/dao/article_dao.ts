...
export class ArticleDAO {
  ...
  public findArticleByAuthor (author: string): Promise<Error | Array<ArticleMeta>> {
    return new Promise((resolve, reject) => {
  ...
  public findArticleById (id: string): Promise<Error | ArticleMeta> {
    return new Promise((resolve, reject) => {
  ...
  public updateArticle (id: string, article: ArticleMeta): Promise<Error | { numberOfUpdated: Number, upsert: boolean }> {
    return new Promise((resolve, reject) => {
  ...
  public deleteArticle (id: string): Promise<Error | Number> {
    return new Promise((resolve, reject) => {
